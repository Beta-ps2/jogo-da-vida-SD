...
def inicializar_grade():
    ...
    # Supondo que LINHAS e COLUNAS sejam suficientemente grandes para suportar um quadrado de 50x50
    tamanho_quadrado = 50
    ...
    # Preencher a grade com 1s no formato de um quadrado de 50x50
