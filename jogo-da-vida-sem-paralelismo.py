...
pygame.display.set_caption("Jogo da Vida sem paralelismo")
    ...
    while rodando:
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.MOUSEBUTTONDOWN:
                ...
                btn_start_stop_x, btn_start_stop_y, btn_start_stop_largura, btn_start_stop_altura = desenhar_botao_parar_e_iniciar(
                    parado)

                # Obtém as dimensões do botão de +
                btn_mais_fps_x, btn_mais_fps_y, btn_mais_fps_largura, btn_mais_fps_altura = desenhar_botao_mais_fps(
                    frames)

                # Obtém as dimensões do botão de -
                btn_menos_fps_x, btn_menos_fps_y, btn_menos_fps_largura, btn_menos_fps_altura = desenhar_botao_menos_fps(
                    frames)

                # Verifica se o clique ocorreu dentro da área do botão de iniciar e parar
                if btn_start_stop_x <= evento.pos[
                    0] <= btn_start_stop_x + btn_start_stop_largura and btn_start_stop_y <= evento.pos[
                    1] <= btn_start_stop_y + btn_start_stop_altura:
                ...
                if btn_mais_fps_x <= evento.pos[0] <= btn_mais_fps_x + btn_mais_fps_largura and btn_mais_fps_y <= \
                        evento.pos[1] <= btn_mais_fps_y + btn_mais_fps_altura:
                    frames = frames + 1

                # Verifica se o clique ocorreu dentro da área do botão MENOS fps
                if btn_menos_fps_x <= evento.pos[0] <= btn_menos_fps_x + btn_menos_fps_largura and btn_menos_fps_y <= \
                        evento.pos[1] <= btn_menos_fps_y + btn_menos_fps_altura:
